...
import com.beezassistant.configurator.models.DetailedScheduledSubmission;
...
@RepositoryRestResource(exported=true, path="scheduledsubmissions", excerptProjection = DetailedScheduledSubmission.class)
